...
全局式快门：通过整幅场景在同一时间曝光实现的。Sensor所有像素点同时收集光线，同时曝光。即在曝光开始的时候，Sensor开始收集光线；在曝光结束的时候，光线收集电路被切断。然后Sensor值读出即为一幅照片。CCD就是Global shutter工作方式。可以通过减少曝光时间来做到提高相机在拍摄高速运动物体的图像质量，减少模糊。
...
卷帘式快门优缺点：逐行曝光，拍摄高速运动物体时性能不佳，会产生果冻效应，适用于静止或者运动变化较慢的物体。
*/
